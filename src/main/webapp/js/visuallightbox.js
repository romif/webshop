/* Visual Lightbox v5.0 (Nov 15, 2011)
 * for jQuery JavaScript Library v1.4.2
 ...
 W.setAttribute("href", "javascript:void(0);");
        ...
        function updateNav() {
            ...
            if (imageArray.length > 1) {
                ...
                {
                	$$("prevLinkImg").show();
                	/*$$("prevLinkImg").addClass("prevLinkImg");
                	$$("prevLinkImg").removeClass("prevLinkImg_no");
                	$$("nextLinkImg").removeClass("nextLinkImg");
                	$$("nextLinkImg").addClass("nextLinkImg_no");*/
                	
                }
                if(activeImage<imageArray.length-1)
                {
                	$$("nextLinkImg").show();
                	/*$$("nextLinkImg").addClass("nextLinkImg");
                	$$("nextLinkImg").removeClass("nextLinkImg_no");
                	$$("prevLinkImg").removeClass("prevLinkImg");
                	$$("prevLinkImg").addClass("prevLinkImg_no");*/
            ...
            enableKeyboardNav();
			/* Тут вставить код не отображения навигации */
