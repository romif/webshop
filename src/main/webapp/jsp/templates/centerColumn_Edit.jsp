							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								<tbody>  
								   ...
								   <tr><td><div>Производитель</div></td><td><input type="text" name="Manufactor" value="input"></td></tr>
									...
									<tr><td><div>Тип процессора</div></td><td><input type="text" name="textProperty8" value="input"></td></tr>
									...
									<tr><td><div>Опт. стабилизация изображения</div></td><td><input name="Checkbox26" type="checkbox"/></td></tr>
